...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabTextColor = 0xFF949494;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs,
        ...
        tabWidth = (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, tabWidth, dm);
    ...
    public void setMultWidth(int multWidth){
...
//		if(tabCount>max_tab) {
//			tab.setMaxWidth(width / max_tab - tabPadding * 2);
//		}
//		tab.setLayoutParams(new LinearLayout.LayoutParams(width / max_tab ,ViewGroup.LayoutParams.MATCH_PARENT));
        if(tabWidth*tabCount<width){
            tab.setWidth((width-multWidth) / tabCount);
        }else{
    ...
    public void setSelectPage(int selectedPosition){
