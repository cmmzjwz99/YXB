package com.cmm.zjwz.custom.pulltorefreshgridView;
...
import com.cmm.zjwz.custom.pulltorefreshlistview.FooterLoadingLayout;
import com.cmm.zjwz.custom.pulltorefreshlistview.ILoadingLayout;
import com.cmm.zjwz.custom.pulltorefreshlistview.LoadingLayout;
import com.cmm.zjwz.custom.pulltorefreshlistview.PullToRefreshBase;
import com.cmm.zjwz.custom.pulltorefreshlistview.RotateLoadingLayout;


/**
 * 这个类实现了GridView下拉刷新，上加载更多和滑到底部自动加载
 */
public class PullToRefreshGridViewWithHeaderAndFooter extends
        PullToRefreshBase<GridViewWithHeaderAndFooter> implements
    ...
    protected GridViewWithHeaderAndFooter createRefreshableView(
        ...
        GridViewWithHeaderAndFooter listView = new GridViewWithHeaderAndFooter(
                context);
        mGridView = listView;
